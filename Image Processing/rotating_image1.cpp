...
int main(int, char** argv)
{
	...
	for (i = 0; i < img_color1.rows; i++)
		for (j = 0; j < img_color1.cols; j++)
			img_color2.at<Vec3b>(j, img_color1.rows - i - 1) = img_color1.at<Vec3b>(i, j);
	...
	moveWindow("Color Image 2", img_color2.cols + 200, 100);
